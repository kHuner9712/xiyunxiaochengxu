...
> **代码 RC，尚未完成高合规品类资质审核与真机支付退款验收。**
> 可进入预生产部署/体验版验收，前提是 P0 材料补齐。
> 不允许标记为"可正式上线"。
...
### 微信审核
- [ ] 隐私协议已填写
- [ ] 隐私协议 URL/页面路径已配置（P0 阻塞项）
- [ ] 用户协议已填写
- [ ] 用户协议 URL/页面路径已配置（P0 阻塞项）
- [ ] 小程序类目已选择
- [ ] 经营资质已上传
- [ ] ICP/小程序备案号已填写（P0 阻塞项）
- [ ] 审核测试账号已提供
- [ ] 提交微信审核
- [ ] 运营字段清单已全部填写（见 docs/14_WECHAT_REVIEW_PACKAGE.md 第7节）
- [ ] 食品/奶粉/保健品资质确认（P0 阻塞项）
- [ ] 食品经营许可证或仅销售预包装食品备案凭证已上传（P0 阻塞项）
- [ ] 保健食品批准文号/备案号已提供（P0 阻塞项）
- [ ] 奶粉产品配方注册号或合规证明已提供（P0 阻塞项）
- [ ] 客服电话/微信/退货地址已最终确认（P0 阻塞项）
- [ ] 隐私协议/用户协议正式内容已确认（P0 阻塞项）
