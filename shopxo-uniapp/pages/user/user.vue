<template>
    <view :class="theme_view">
        ...
        <!-- 阶段引导弹窗 -->
        <component-stage-guide :propShow="stage_guide_show" @confirm="stage_guide_confirm_event" @skip="stage_guide_skip_event"></component-stage-guide>
