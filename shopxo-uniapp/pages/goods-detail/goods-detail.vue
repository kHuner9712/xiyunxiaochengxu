            ...
            <view class="padding-horizontal-main">
                ...
                <view class="goods-base-content border-radius-main bg-white spacing-mb">
                    <view class="padding-main">
                        ...
                        <!-- 商品卖点 -->
                        <view v-if="muying_selling_points.length > 0" class="muying-selling-points flex-row margin-top-sm">
                            <block v-for="(point, pidx) in muying_selling_points" :key="pidx">
                                <view class="muying-selling-point-item">
                                    <view class="muying-selling-point-dot"></view>
                                    <text class="muying-selling-point-text">{{ point }}</text>
                                </view>
                            </block>
                        </view>
                    </view>
                ...
                <!-- 适用阶段 -->
                <view class="muying-stage-container border-radius-main bg-white spacing-mb">
                    <view class="muying-stage-header flex-row align-c">
                        <text class="muying-stage-title">适用阶段</text>
                        <view class="muying-divider flex-1"></view>
                    </view>
...
<script>
    ...
    import componentGoodsBatchBuy from '@/pages/goods-detail/components/common/goods-batch-buy/goods-batch-buy';
    import componentPopup from '@/components/popup/popup';
    import componentBadge from '@/components/badge/badge';
    import componentTrnNav from '@/pages/goods-detail/components/common/trn-nav/trn-nav';
    import componentCountdown from '@/components/countdown/countdown';
    import componentNoData from '@/components/no-data/no-data';
    import componentBottomLine from '@/components/bottom-line/bottom-line';
    import componentOnlineService from '@/components/online-service/online-service';
    import componentRealstoreList from '@/pages/goods-detail/components/common/realstore-list/realstore-list';
    import componentShopList from '@/pages/goods-detail/components/common/shop-list/shop-list';
    import componentBindingDetailList from '@/pages/goods-detail/components/common/binding-detail-list/binding-detail-list';
    ...
    import componentWholesaleRules from '@/pages/goods-detail/components/common/wholesale-rules/wholesale-rules';
    import componentAskCommentsGoods from '@/pages/goods-detail/components/common/ask-comments-goods/ask-comments-goods';
